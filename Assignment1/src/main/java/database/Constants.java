...
public class Constants {
    ...
    public static class Tables{
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER,ROLE,RIGHT,ROLE_RIGHT,USER_ROLE,CLIENT,ACCOUNT,TRANSACTION,BILL};
    }
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_CLIENT,UPDATE_CLIENT,CREATE_ACCOUNT,DELETE_ACCOUNT,UPDATE_ACCOUNT,CREATE_EMPLOYEE,DELETE_EMPLOYEE,UPDATE_EMPLOYEE};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_CLIENT,  UPDATE_CLIENT, CREATE_ACCOUNT,UPDATE_ACCOUNT,DELETE_ACCOUNT));
